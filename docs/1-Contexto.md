...
## Objetivos
Objetivo Geral
Desenvolver uma plataforma digital que conecte clientes e profissionais de serviços manuais e técnicos, proporcionando rapidez, segurança e organização no processo de contratação.

Objetivos Específicos
Simplificar a busca por prestadores de serviços, permitindo filtros avançados por tipo de serviço, localização e reputação.
